...
const Forum = () => {
  const posts = [
    ...
    },
    {
      title: "Meal Prepping 101: Save Time & Eat Healthy",
      snippet:
        "A beginner's guide to mastering the art of meal prepping.A beginner's guide to mastering the art of meal prepping.A beginner's guide to mastering the art of meal prepping.",
      category: "Fitness",
      userType: "trainer",
      author: "John S.",
      date: "January 9, 2025",
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                ...
                <div>
                  ...
                  >
                    {post.userType === "admin" ? "Admin" : "Trainer"}
                  </span>
                </div>
              </div>
